...
class StockDataLoader:
    ...
    def filter_date_range(self, ticker, start_date, end_date):
        ...
        return None
def fetch_news_api(ticker, max_articles=20):
    """
    Fetch latest news for a ticker using NewsAPI
    ...
    """
    NEWS_API_KEY = "a262dd9b69d047e4a8073653d022a3a0"

    url = f"https://newsapi.org/v2/everything?q={ticker}&sortBy=publishedAt&pageSize={max_articles}&apiKey={NEWS_API_KEY}"
